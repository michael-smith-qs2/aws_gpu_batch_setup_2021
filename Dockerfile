# FROM python:3.8  # no CUDA or pytorch
# FROM nvidia/cuda:11.3.0-cudnn8-runtime-centos8  # no python, doesn't match AWS instance OS
# FROM nvidia/cuda:11.0-base  # also doesn't match AWS instance
# FROM pytorch/pytorch:latest  # no CUDA
# FROM pytorch/pytorch:1.6.0-cuda10.1-cudnn7-runtime  # too old, doesn't match AWS instance GPU
